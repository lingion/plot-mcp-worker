...
![三角函数组合](docs/showcase/trig_composition.png)
...
![傅里叶逼近](docs/showcase/fourier_approx.png)
...
![tan 不连续](docs/showcase/tan_discontinuity.png)
...
![sinc 函数](docs/showcase/sinc_function.png)
...
![有理函数渐近线](docs/showcase/rational_asymptotes.png)
...
![阻尼振荡](docs/showcase/damped_oscillation.png)
...
![整流乘积](docs/showcase/absolute_value.png)
...
![高斯混合](docs/showcase/gaussian_mixture.png)
...
![标注峰值](docs/showcase/annotated_peaks.png)
...
![业务误差条](docs/showcase/business_error_bars.png)
...
![分组柱状](docs/showcase/grouped_bars.png)
...
![堆叠柱状](docs/showcase/stacked_bars.png)
...
![饼图](docs/showcase/pie_chart.png)
...
![直方图](docs/showcase/histogram.png)
...
![箱线图](docs/showcase/box_plot.png)
...
![对数坐标](docs/showcase/log_scale.png)
...
![非对称误差](docs/showcase/scatter_asymmetric.png)
...
![变换管线](docs/showcase/transform_pipeline.png)
...
![子图网格](docs/showcase/subplot_2x2.png)
...
![定积分教学](docs/showcase/teaching_integral.png)
